...
namespace {
	constexpr color_type RED_TINT { 0xFFU, 0x00U, 0x00U, 0x7FU };
	constexpr color_type GREEN_TINT { 0x00U, 0xFFU, 0x00U, 0x7FU };
	constexpr color_type BLUE_TINT { 0x00U, 0x00U, 0xFFU, 0x7FU };
	constexpr color_type WHITE_TINT { 0xFFU, 0xFFU, 0xFFU, 0x7FU };
}
...
void ecs::kinematics::render(renderer_2d& renderer, const environment& env) {
