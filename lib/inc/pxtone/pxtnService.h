...
public :
	...
	pxtnService();
	pxtnService(const pxtnService&) = delete;
	pxtnService& operator=(const pxtnService&) = delete;
	pxtnService(pxtnService&&) noexcept = default;
	pxtnService& operator=(pxtnService&&) noexcept = default;
	~pxtnService();
