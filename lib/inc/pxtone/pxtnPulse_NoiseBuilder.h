...
public :
	...
	pxtnPulse_NoiseBuilder(const pxtnPulse_NoiseBuilder&) = delete;
	pxtnPulse_NoiseBuilder& operator=(const pxtnPulse_NoiseBuilder&) = delete;
	pxtnPulse_NoiseBuilder(pxtnPulse_NoiseBuilder&&) noexcept = default;
	pxtnPulse_NoiseBuilder& operator=(pxtnPulse_NoiseBuilder&&) noexcept = default;
	~pxtnPulse_NoiseBuilder();
