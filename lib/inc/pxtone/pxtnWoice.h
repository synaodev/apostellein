...
public :
	pxtnWoice();
	pxtnWoice(const pxtnWoice&) = delete;
	pxtnWoice& operator=(const pxtnWoice&) = delete;
	pxtnWoice(pxtnWoice&&) noexcept = default;
	pxtnWoice& operator=(pxtnWoice&&) noexcept = default;
	~pxtnWoice();
