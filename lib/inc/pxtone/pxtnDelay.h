...
public :
	...
	pxtnDelay();
	pxtnDelay(const pxtnDelay&) = delete;
	pxtnDelay& operator=(const pxtnDelay&) = delete;
	pxtnDelay(pxtnDelay&&) noexcept = default;
	pxtnDelay& operator=(pxtnDelay&&) noexcept = default;
	~pxtnDelay();
