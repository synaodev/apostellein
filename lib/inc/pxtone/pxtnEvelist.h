...
public:
	...
	pxtnEvelist();
	pxtnEvelist(const pxtnEvelist&) = delete;
	pxtnEvelist& operator=(const pxtnEvelist&) = delete;
	pxtnEvelist(pxtnEvelist&&) noexcept = default;
	pxtnEvelist& operator=(pxtnEvelist&&) noexcept = default;
	~pxtnEvelist();
