...
public:
	pxtnPulse_Noise();
	pxtnPulse_Noise(const pxtnPulse_Noise&) = delete;
	pxtnPulse_Noise& operator=(const pxtnPulse_Noise&) = delete;
	pxtnPulse_Noise(pxtnPulse_Noise&&) noexcept = default;
	pxtnPulse_Noise& operator=(pxtnPulse_Noise&&) noexcept = default;
	~pxtnPulse_Noise();
