...
public :
	pxtnMaster();
	pxtnMaster(const pxtnMaster&) = delete;
	pxtnMaster& operator=(const pxtnMaster&) = delete;
	pxtnMaster(pxtnMaster&&) noexcept = default;
	pxtnMaster& operator=(pxtnMaster&&) noexcept = default;
	~pxtnMaster();
