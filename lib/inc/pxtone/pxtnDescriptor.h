...
public:
	...
	pxtnDescriptor();
	pxtnDescriptor(const pxtnDescriptor&) = delete;
	pxtnDescriptor& operator=(const pxtnDescriptor&) = delete;
	pxtnDescriptor(pxtnDescriptor&&) noexcept = default;
	pxtnDescriptor& operator=(pxtnDescriptor&&) noexcept = default;
