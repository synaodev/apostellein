...
public:
	...
	pxtnPulse_PCM();
	pxtnPulse_PCM(const pxtnPulse_PCM&) = delete;
	pxtnPulse_PCM& operator=(const pxtnPulse_PCM&) = delete;
	pxtnPulse_PCM(pxtnPulse_PCM&&) noexcept = default;
	pxtnPulse_PCM& operator=(pxtnPulse_PCM&&) noexcept = default;
	~pxtnPulse_PCM();
